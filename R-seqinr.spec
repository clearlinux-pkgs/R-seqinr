...
Version  : 4.2.16
Release  : 40
URL      : https://cran.r-project.org/src/contrib/seqinr_4.2-16.tar.gz
Source0  : https://cran.r-project.org/src/contrib/seqinr_4.2-16.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1653008637
