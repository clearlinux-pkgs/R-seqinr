...
Version  : 3.6.1
Release  : 15
URL      : https://cran.r-project.org/src/contrib/seqinr_3.6-1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/seqinr_3.6-1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1567889359
