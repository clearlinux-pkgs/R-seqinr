...
export LANG=C
export SOURCE_DATE_EPOCH=1530301835
...
R CMD check --no-manual --no-examples --no-codoc -l %{buildroot}/usr/lib64/R/library seqinr|| : 
cp ~/.stash/* %{buildroot}/usr/lib64/R/library/*/libs/ || :
...
/usr/lib64/R/library/seqinr/libs/symbols.rds
