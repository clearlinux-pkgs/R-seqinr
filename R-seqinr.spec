...
Version  : 4.2.30
Release  : 46
URL      : https://cran.r-project.org/src/contrib/seqinr_4.2-30.tar.gz
Source0  : https://cran.r-project.org/src/contrib/seqinr_4.2-30.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1680795588
